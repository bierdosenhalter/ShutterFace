...
namespace ShutterFace
{
    ...
    /// </summary>
    internal sealed class AnalysisEngine(PlayerModel model)
    {
        ...
        public void Analyze(TrackingRect tracking)
        {
        ...
        /// </summary>
        public bool TrackObject(TrackingRect tracking, int frameIndex)
        {
