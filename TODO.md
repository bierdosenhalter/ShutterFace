...
- when exporting a video the export menu entry gets disabled and another export is not possible anymore
- there is a save buttin in tracking properties that is not functional and obsolete
...
- open and save projects should be first in the file menu then a seperator and then open video
